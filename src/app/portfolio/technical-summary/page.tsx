...
const skills = [
  { category: 'Languages', items: 'TypeScript, JavaScript, Python, C#, F#, Java, HTML, CSS' },
  ...
  { category: 'Integrations', items: 'Salesforce, Storyblok CMS, Google Maps/Places/Analytics, OneSignal, Sentry, Threekit, Logik' },
  ...
  { category: 'Other', items: 'SCORM, Formik/Yup, D3.js, i18n, JasperReports XML, GraphQL' },
]
